...
int main(int argc, char **argv)
{
  ...
  fprintf(stdout, "   delete (1 int id arg)\n   update (arg for each column:id name breed)\n   add (arg for each column: id name breed)\n");
  ...
  else
  {
    ...
    { // error condition from unmarshalled message
    ...
    { // message was received successfully, print it out
